...
export const About = () => {
  const timeline = [
    {
      ...
      company: 'Makrocare',
      description:
        'I’m a DevOps Engineer with experience in clinical domain projects, focusing on high availability both on Prem & cloud automation, and CI/CD pipelines. I work with AWS, Docker, and Kubernetes to build scalable, reliable, and secure systems. I enjoy optimizing workflows, automating deployments, and ensuring smooth, consistent releases across environments.',
      icon: Code,},
    {
      year: '2017 - 2020',
      title: 'Bachelor Computer Science Graduate',
  ...
  const philosophyPoints = [
    ...
    },
    {
      ...
      description: 'Build for the cloud and onprem from day one, embrace containerization.',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-bg-page">
      ...
      <TerminalHeader
        ...
        description="Displaying professional background and technical experience"
      />
            ...
            >
              <div className="bg-bg-surface border border-neutral-700 rounded-xl p-8 shadow-card">
                ...
                <div className="space-y-4 text-neutral-200 leading-relaxed">
                  <Typewriter
                    text="Hello, I'm Rohith, and I deploy applications into production reality."
                    delay={30}
                    className="text-primary-500 font-semibold block mb-4"
                  />
                  <p>
                    I’m a DevOps and Release Engineer with hands-on experience in building reliable, scalable, and automated systems. Over the last few years, I’ve worked with CI/CD pipelines, cloud platforms like AWS & Azure, containerization, Kubernetes, monitoring tools, and end-to-end deployment automation.
                  </p>
                  <p>
                    I’m passionate about solving real-world engineering problems—whether it’s improving deployment speed, reducing system downtime, or optimizing infrastructure performance. I enjoy designing streamlined workflows, writing clean automation scripts, and ensuring software moves from development to production smoothly and securely.
                  </p>
                  <p>
            ...
            >
              ...
              <div className="bg-bg-elevated border border-neutral-700 rounded-xl p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {['Cloud Computing (AWS & AZURE)','DevOps engineering','CI/CD Pipelines', 'Infrastructure as Code', 'Container Orchestration','High-Availability Systems','Monitoring & Observability','Release Engineering','Linux & Windows System Engineering', 'webservers'].map((skill) => (
                    <span
                      key={skill}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-neutral-400 max-w-2xl mx-auto">
              My total experience is on DevOps  and release engineering
            </p>
          </motion.div>
